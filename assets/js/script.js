...
function showQestion(){
    ...
    for (var i = 0; i < randomQuestions.answers.length; i++) {
        ...
        button.setAttribute("style", " background-color:#b6ecfa;color:#306da7; padding: 20px;font-family: 'Courier New', Courier, monospace;font-weight: bold;font-size: 16;border-radius: 8px; border-color:#f07469; margin:20px;");
